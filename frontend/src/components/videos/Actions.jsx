...
const Actions = ({ post }) => {
    ...
    // curtir e tirar like de um post
    ...
    const handleReply = async () => {
        ...
        try {
            ...
            // Atualiza o estado dos posts com o novo comentário
            const updatedPosts = posts.map((p) => {
                if (p._id === post._id) {
    ...
    return (
        <>
            {/* Seção de ações */}
            <Flex mt={5} flexDir="flex" gap={4} onClick={(e) => e.preventDefault()}>
